...
const Pricing = ({
  ...
  return (
    <>
      <DynHead
        title="Pricing"
        description="A website is like a home for your business, where all the roads from social media and web searches lead. People land there and expect clarity on what you do, how you do it, for whom you do it, and most importantly, why you do it."
